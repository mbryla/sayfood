  ...
  return (
    <>
      <AppBar style={{ backgroundColor: '#01579b'}}>
        <Toolbar>
          <img src="/sayfood-logo.png" style={{height: "100px"}} ></img>
          <Typography variant="h4">Welcome</Typography>
        </Toolbar>
      </AppBar>
      <Box mt={5} display="flex" flexDirection="column" alignItems="center">
        <Box mt={20}>
          <Button color="primary" onClick={() => props.history.push("/myrestaurant/verify")}>Verify a reservation</Button>
        </Box>
        <Box mt={10}>
          <Button color="secondary" onClick={() => props.history.push("/myrestaurant/cancel")}>Cancel a reservation</Button>
        </Box>
      </Box>
    </>
  );
...
export const VerifyReservation: FC<RouteComponentProps> = (props) => {
  return <ReservationCodeSubmissionPage
      actionUrl="" //TODO
